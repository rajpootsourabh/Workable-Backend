...
class JobPostController extends Controller
{
    ...
    public function createJob(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'job_description' => 'required|string|max:600',
            'job_requirements' => 'nullable|string|max:600',
            'job_benefits'    => 'nullable|string|max:600',
    ...
    public function updateJob(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            'job_description' => 'sometimes|string|max:600',
            'job_function'    => 'sometimes|string|max:255',
            'job_requirements'    => 'sometimes|string|max:600',
            'job_benefits'    => 'sometimes|string|max:600',
