...
class LegalDocumentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'ssn_file' => $this->ssn_file ? generateFileUrl($this->ssn_file) : null,
            'national_id' => $this->national_id,
            'issue_date_national_id' => $this->issue_date_national_id,
            'national_id_file' => $this->national_id_file ? generateFileUrl($this->national_id_file) : null,
            'social_insurance_number' => $this->social_insurance_number,
            'tax_id' => $this->tax_id,
            'issue_date_tax_id' => $this->issue_date_tax_id,
            'tax_id_file' => $this->tax_id_file ? generateFileUrl($this->tax_id_file) : null,
